  ...
  const handleShareInstead = async () => {
    ...
    try {
      ...
      if (shareResult.success) {
        ...
        // Best-effort filename even on the share path, instead of leaving
        // savedFileName null -- the local file still has a real name, it
        // just wasn't copied into a user-chosen Downloads folder.
        setSavedFileName(shareResult.localUri ? shareResult.localUri.split('/').pop() : null);
      }
    } catch (error) {
